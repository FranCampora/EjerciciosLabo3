...
int main(int argc, char  *argv[])
{
    ...
    while (i < MAX_USERS)
    {
        ...
        clienteUsando[i].saldo_final = SALDO_INICIAL;
        i++;
    }
        ...
        switch (msg.int_evento)
        {
            case EVT_CONSULTA_SALDO:
                ...
                if (auxCliente != NULL)
                {
                    ...
                    enviar_mensaje(id_cola_mensajes,msg.int_rte,MSG_BANCO,EVT_RTA_SALDO,szBuffer);
                ...
                }else
                {
                    ...
                    enviar_mensaje(id_cola_mensajes,msg.int_rte,MSG_BANCO,EVT_RTA_SALDO_NOK,szBuffer);
            ...
            case EVT_DEPOSITO:
                ...
                if (auxCliente != NULL)
                {
                    ...
                    enviar_mensaje(id_cola_mensajes,msg.int_rte,MSG_BANCO,EVT_RTA_DEPOSITO_OK,szBuffer);
                ...
                }else
                {
                    ...
                    enviar_mensaje(id_cola_mensajes,msg.int_rte,MSG_BANCO,EVT_RTA_DEPOSITO_NOK,szBuffer);
            ...
            case EVT_EXTRACCION:
                ...
                if (auxCliente != NULL)
                {
                    if (auxCliente->saldo_final >= monto)
                    {
                        ...
                        enviar_mensaje(id_cola_mensajes,msg.int_rte,MSG_BANCO,EVT_RTA_EXTRACCION_OK,szBuffer);
                    ...
                    }else
                    {
                        ...
                        enviar_mensaje(id_cola_mensajes,msg.int_rte,MSG_BANCO,EVT_RTA_EXTRACCION_NOK,szBuffer);
                        ...
                        enviar_mensaje(id_cola_mensajes,msg.int_rte,MSG_BANCO,EVT_RTA_EXTRACCION_NOK,"NO SE ENCONTRO CLIENTE");        
                    }
            ...
            case EVT_FIN:
                ...
                enviar_mensaje(id_cola_mensajes,msg.int_rte,MSG_BANCO,EVT_FIN,"BANCO CERRADO");
